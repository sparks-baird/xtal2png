...
``xtal2png`` documentation uses Sphinx_ as its main documentation compiler.
...
.. _repository: https://github.com/<USERNAME>/xtal2png
.. _issue tracker: https://github.com/<USERNAME>/xtal2png/issues
.. <-- end -->
